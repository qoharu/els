...
class Discussion_model extends CI_Model
{
	...
	function todo(){
		...
		return $this->db->query("SELECT keterangan, created_at, id_step, step.id_scope, scope_name
			FROM step, scope
	...
	function disc_list(){
		$uid = $this->session->userdata('uid');
		return $this->db->query("SELECT title, created_at, content, scope_name, status, id_step, id_discussion
