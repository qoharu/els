	...
	<div class="row isi">
		<div class="col-md-8 col-md-offset-2 isi">
					...
					<div class="box-header with-border">
						<h3>Close forum for <?php echo $thread[0]->title ?></h3>
					</div>
					<div class="box-body">
						<form class="" action="<?php echo site_url('discussion/disc_close_post/'.$thread[0]->id_discussion); ?>" method="post" enctype="multipart/form-data">
