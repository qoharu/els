        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="<?php echo base_url('uploads/profile/default.png') ?>" class="img-circle" alt="User Image">
            </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php echo @$active[0] ?>"><a href="<?php echo site_url('admin/summary') ?>"><i class="fa fa-list"></i> <span>Administration</span></a></li>
            <li class="<?php echo @$active[1] ?>"><a href="<?php echo site_url('admin/user') ?>"><i class="fa fa-users"></i><span>Users</span></a></li>
            <li class="<?php echo @$active[6] ?>"><a href="<?php echo site_url('admin/register') ?>"><i class="fa fa-user-plus"></i><span>Register</span></a></li>
