			...
			<div class="box-body">
				<form class="" action="<?php echo site_url('journal/post_new') ?>" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<input class="form-control input-md" type="text" name="title" placeholder="Judul">
					</div>
					<div class="form-group">
						<textarea name="description" class="form-control input-md" id="" rows="5" maxlength="500" placeholder="Deskripsi"></textarea>	
					</div>
					<div class="form-group">
						<select name="directorate" class="form-control" id="">
